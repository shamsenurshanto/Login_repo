...
class LoanGivenPages extends StatefulWidget {
  const LoanGivenPages({super.key});

  @override
  State<LoanGivenPages> createState() => _LoanGivenPagesState();
}

class _LoanGivenPagesState extends State<LoanGivenPages> {
  @override
  var _data;
   var jsonData;
  @override
